...
import com.wjy.utils.JsonUtils;
import com.wjy.utils.PropertiesUtils;
...
public class BuildTable {
    ...
    public static List<TableInfo> getTables() throws SQLException {
        ...
        try {
            ...
            while (tableResult.next()) {
                ...
                tableInfo.setBeanParamsName(beanName + Constants.SUFFIX_BEAN_QUERY);
    ...
    private static void readFieldInfo(TableInfo tableInfo) throws SQLException {
        PreparedStatement ps = null;
        ...
        try {
            ...
            while (fieldResult.next()) {
                ...
                String isNull = fieldResult.getString("null");
                ...
                fieldInfo.setIsNullable("YES".equalsIgnoreCase(isNull));
    ...
    private static List<FieldInfo> getKeyIndexInfo(TableInfo tableInfo) throws SQLException {
        PreparedStatement ps = null;
        ResultSet fieldResult = null;
