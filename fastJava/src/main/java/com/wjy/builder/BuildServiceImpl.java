...
//            }
            ...
            bw.write("\tprivate " + mapperName + "<" + tableInfo.getBeanName() + ", " + tableInfo.getBeanParamsName() + "> " + StringUtils.lowerCaseFirstLetter(mapperName) + ";");
            bw.newLine();
            bw.newLine();
            bw.newLine();
            BuildComment.createFieldComment(bw,"根据条件查询列表");
            bw.write("\tpublic List<" + tableInfo.getBeanName() + "> findListByParam(" + tableInfo.getBeanParamsName() + " query) {");
            bw.newLine();
            ...
            bw.write("\tpublic Integer findCountByParam(" + tableInfo.getBeanParamsName() + " query) {");
            bw.newLine();
            ...
            bw.write("\tpublic PaginationResultVO<" + tableInfo.getBeanName() + "> findListByPage(" + tableInfo.getBeanParamsName() + " query) {");
            bw.newLine();
